...
def test():
    ...
    with colors.pretty_output(colors.BOLD, colors.FG_RED) as out:
        print()
        out.write("THE AVAILABLE DOMAINS ARE ")
        print()
        out.write("VOTING  GULFWAR  PARLIAMENT  WORLD BANK")
        print()
    with colors.pretty_output(colors.BOLD, colors.FG_GREEN) as out:
        out.write("Press 1 for VOTING")
        print()
        out.write("Press 2 for GULFWAR")
        print()
        out.write("Press 3 for PARLIAMENT")
        print()
        out.write("Press 4 for WORLD-BANK")
        print()
        out.write("Press 5 for ANY OTHER DOMAIN")
        print()

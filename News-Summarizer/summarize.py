# summarize.py
# Original algorithm implementation by Luke Reichold - CSCI 4930
# This is a implementation of multi-document summarization using Tf-Idf method
# term frequency and multi document frequency
